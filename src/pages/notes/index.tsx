          ...
          <TableContainer>
            <Table variant="simple">
              <Thead>
                <Tr>
                  <Th>content</Th>
                  {hasAccess('therapist', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>therapist</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('therapist', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/therapists/view/${record.therapist?.id}`}>
                          {record.therapist?.id}
                        </Link>
                      </Td>
                    )}
